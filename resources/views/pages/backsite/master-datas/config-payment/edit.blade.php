                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.config-payment.update', [$configPayment->id]) }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="fee" name="fee"
                                                            ...
                                                            value="{{ old('fee', isset($configPayment) ? $configPayment->fee : '') }}"
                                                            autocomplete="off"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="vat" name="vat"
                                                            class="form-control" placeholder="example vat 10000"
                                                            value="{{ old('vat', isset($configPayment) ? $configPayment->vat : '') }}"
                                                            autocomplete="off"
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.config-payment.index') }}" style="width:120px;"
