                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr data-entry-id="{{ $config_payment->id }}">
                                                            <td>{{ isset($config_payment->created_at) ? date('d/m/Y H:i:s', strtotime($config_payment->created_at)) : '' }}
                                                            </td>
                                                            <td>{{ 'IDR ' . number_format($config_payment->fee) ?? '' }}
                                                            </td>
                                                            <td>{{ number_format($config_payment->vat) . '%' ?? '' }}
                                                            </td>
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        @can('config_payment_edit')
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('backsite.config-payment.edit', $config_payment->id) }}">
                                                                                Edit
                                                                            </a>
                                                                        @endcan
