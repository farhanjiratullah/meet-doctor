                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.doctors.store') }}"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div
                                                        ...
                                                        <label class="col-md-3 label-control" for="specialist_id">Specialist
                                                            ...
                                                            <select name="specialist_id" id="specialist_id"
                                                                ...
                                                                @foreach ($specialists as $key => $specialist_item)
                                                                    <option value="{{ $specialist_item->id }}"
                                                                        {{ old('specialist_id') == $specialist_item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse($doctors as $key => $doctors_item)
                                                            <tr data-entry-id="{{ $doctors_item->id }}">
                                                                <td>{{ isset($doctors_item->created_at) ? date('d/m/Y H:i:s', strtotime($doctors_item->created_at)) : '' }}
                                                                </td>
                                                                <td>{{ $doctors_item->specialist->name ?? '' }}</td>
                                                                <td>{{ $doctors_item->name ?? '' }}</td>
                                                                <td>{{ 'IDR ' . number_format($doctors_item->fee) ?? '' }}</td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $doctors_item->photo }}"
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('doctor_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.doctors.show', $doctors_item->id) }}"
                                                                            ...
                                                                            @can('doctor_edit')
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.doctors.edit', $doctors_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @can('doctor_delete')
                                                                                <form
                                                                                    action="{{ route('backsite.doctors.destroy', $doctors_item->id) }}"
                                                                                    method="POST"
