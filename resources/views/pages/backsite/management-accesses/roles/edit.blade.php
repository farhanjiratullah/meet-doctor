                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.roles.update', [$role->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div
                                                    ...
                                                    <label class="col-md-3 label-control">Permissions <code
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        ...
                                                        <select name="permissions[]" id="permissions"
                                                            ...
                                                            multiple="multiple">
                                                            @foreach ($permissions as $id => $permission_item)
                                                                <option value="{{ $permission_item->id }}"
                                                                    {{ in_array($permission_item->id, old('permissions', [])) || (isset($role) && $role->permissions->contains($permission_item->id)) ? 'selected' : '' }}>
                                                                    {{ $permission_item->name }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.roles.index') }}" style="width:120px;"
