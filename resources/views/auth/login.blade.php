    ...
    <div class="min-h-screen">
        <div class="grid lg:grid-cols-2">
            ...
            <div class="px-4 lg:px-[91px] pt-10">
                ...
                <!-- Logo Brand -->
                <a href="{{ route('landing') }}" class="flex-shrink-0 inline-flex items-center">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="grid gap-6">
                            ...
                            <label class="block" for="email">
                                <input type="email" id="email" name="email" value="{{ old('email') }}" autofocus
                                    class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#6791db]"
